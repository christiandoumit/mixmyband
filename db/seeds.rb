...
# brain_flower = User.create!(first_name: "Theo", last_name: "Poncet", type_of_user: "Artist", artist_name: "Brain Flower", music_type: "Alternative Rock", artist_type: "Professional Band", price: "350$", fb_url: "https://www.facebook.com/BrainflowerBand", youtube_url: "https://www.youtube.com/channel/UC8EpshxnqopvKFqoTFaPPzA")
bar_datcha = User.create!(first_name: "Jack", last_name: "Kimmer", type_of_user: "eventer", description: "Hip, low-lit cocktail bar with a Russian theme.", venue_type: "club", crowd_type: "other",eventer_name: "Russian Nights", music_type: "electro", artist_type: "dj", email: "bardatch@gmail.com", password: "123456", venue_address: "98 Avenue Laurier O, Montreal", avatar:"", event_type: "dj set")
...
#Artists
brain_flower = User.create!(first_name: "Theo", last_name: "Poncet", type_of_user: "artist", artist_name: "Brain Flower", music_type: "rock", artist_type: "band", price: "300", email: "flower@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/BrainflowerBand", description: "Band looking to play live, enjoy a relaxed night with quality music. We love to offer the best quality possible.", avatar:"")
audio_url_1 = AudioUrl.create! url: "https://soundcloud.com/brainflowerband/i-wanna-be-the-sun", user: brain_flower
audio_url_2 = AudioUrl.create! url: "https://soundcloud.com/brainflowerband/the-dude", user: brain_flower
audio_url_3 = AudioUrl.create! url: "https://soundcloud.com/brainflowerband/peter-carla", user: brain_flower
audio_url_4 = AudioUrl.create! url: "https://soundcloud.com/brainflowerband/so-do-i", user: brain_flower
...
audio_url_1 = AudioUrl.create! url: "https://soundcloud.com/tirelecoyote/bombe-a-retardement-1", user: tire_loup
audio_url_2 = AudioUrl.create! url: "https://soundcloud.com/tirelecoyote/toit-cathedrale-1", user: tire_loup
audio_url_3 = AudioUrl.create! url: "https://soundcloud.com/tirelecoyote/calfeutrer-les-failles-2", user: tire_loup
audio_url_4 = AudioUrl.create! url: "https://soundcloud.com/tirelecoyote/matiere-premiere", user: tire_loup
...
image_1 = Image.create image_src:"/images/tire_le_coyote_1.jpg", user: brain_flower
image_2 = Image.create image_src:"/images/tire_le_coyote_2.jpg", user: brain_flower
image_3 = Image.create image_src:"/images/tire_le_coyote_3.jpg", user: brain_flower
image_4 = Image.create image_src:"/images/tire_le_coyote_4.jpg", user: brain_flower


dany_placard= User.create!(first_name: "Daniel", last_name: "Placard", type_of_user: "artist", artist_name: "Dany Placard", music_type: "rock", artist_type: "solo musician", price: "150", email: "placard@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/danyplacard/", description: "Solo artist looking for an event where people are ready to sing along my popular covers.", avatar:"")
audio_url_1 = AudioUrl.create! url: "https://soundcloud.com/danyplacard/pulperie", user: dany_placard
audio_url_2 = AudioUrl.create! url: "https://soundcloud.com/danyplacard/montagnes-russes", user: dany_placard
audio_url_3 = AudioUrl.create! url: "https://soundcloud.com/danyplacard/vince", user: dany_placard
...
image_1 = Image.create image_src:"/images/dany_placard_1.jpg", user: brain_flower
image_2 = Image.create image_src:"/images/dany_placard_2.jpg", user: brain_flower
image_3 = Image.create image_src:"/images/dany_placard_3.jpg", user: brain_flower
image_4 = Image.create image_src:"/images/dany_placard_4.jpg", user: brain_flower

brooke = User.create!(first_name: "Todd", last_name: "Poulin", type_of_user: "artist", artist_name: "Brooks", music_type: "rock", artist_type: "band", price: "100", email: "brooks@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/TheBrooksMTL/", description: "Best rock band in town. We have 5 albums out and we would like to play everynight of the next week in a venue", avatar:"")
audio_url_1 = AudioUrl.create! url: "https://soundcloud.com/thebrooksmtl/sexylous", user: brooke
audio_url_2 = AudioUrl.create! url: "https://soundcloud.com/thebrooksmtl/priceless", user: brooke
audio_url_3 = AudioUrl.create! url: "https://soundcloud.com/thebrooksmtl/mama", user: brooke
audio_url_4 = AudioUrl.create! url: "https://soundcloud.com/thebrooksmtl/freewheelin-walking", user: brooke
...
image_1 = Image.create image_src:"/images/brooks_1.jpg", user: brain_flower
image_2 = Image.create image_src:"/images/brooks_2.jpg", user: brain_flower
image_3 = Image.create image_src:"/images/brooks_3.jpg", user: brain_flower
image_4 = Image.create image_src:"/images/brooks_4.jpg", user: brain_flower

#Batch #1 of seeds for all types


jean_leloup = User.create!(first_name: "Jean", last_name: "Loup", type_of_user: "artist", artist_name: "Jean Le Loup", music_type: "folk", artist_type: "singer-songwriter", price: "to be discussed", email: "leloup@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/jeanleloupofficiel/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

galaxie = User.create!(first_name: "Mark", last_name: "Marino", type_of_user: "artist", artist_name: "Galaxie", music_type: "blues", artist_type: "band", price: "100", email: "galaxie@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/GroupeGalaxie/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

pussy_stentch = User.create!(first_name: "Devon", last_name: "Keer", type_of_user: "artist", artist_name: "Pussy Stentch", music_type: "metal", artist_type: "band", price: "150", email: "pstentch@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/pstenchmtl/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
last_assassins = User.create!(first_name: "Maria", last_name: "Anastoov", type_of_user: "artist", artist_name: "The Last Assassins", music_type: "rnb", artist_type: "band", price: "100", email: "brokeee@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/thelastassassins/?eid=ARAPzZ5HvHFhIhwJysN0gfEzXT5Y0Z4msKmzRjuJrIXIMCh4U30456N5b31qtIEXZyWXxfIMUKqQ599H", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
fudge = User.create!(first_name: "Markus", last_name: "Johnson", type_of_user: "artist", artist_name: "Fuudge", music_type: "indie", artist_type: "band", price: "100", email: "fuudge@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/fuudgeband/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

# Batch number 2 for all the genres

klaus = User.create!(first_name: "Klaus", last_name: "Iohannis", type_of_user: "artist", artist_name: "Klaus", music_type: "folk", artist_type: "band", price: "to be discussed", email: "klaus@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/klausbandmtl/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
bleu_nuit = User.create!(first_name: "Devan", last_name: "Mikael", type_of_user: "artist", artist_name: "Bleu Nuit", music_type: "metal", artist_type: "band", price: "150", email: "bleu_nuit@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/bleunuitmtl/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

mooch = User.create!(first_name: "Benji", last_name: "Tremblay", type_of_user: "artist", artist_name: "Mooch", music_type: "funk", artist_type: "band", price: "250", email: "mooch@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/moochmusicofficial/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
dj_robertino= User.create!(first_name: "Roberto", last_name: "Melasco", type_of_user: "artist", artist_name: "Dj Robertino", music_type: "electro", artist_type: "dj", price: "350", email: "djrobertino@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/DjRobertinoCosentini/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
 ...
 guster = User.create!(first_name: "Valeria", last_name: "Moreno", type_of_user: "artist", artist_name: "Guster", music_type: "pop", artist_type: "solo musician", price: "free", email: "vitanga@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/gutserdepmetal/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
the_fats = User.create!(first_name: "Rene", last_name: "Vilanueva", type_of_user: "artist", artist_name: "The Fats", music_type: "jazz", artist_type: "band", price: "150", email: "renarrrrd@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/fatsMTL/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
big_vein = User.create!(first_name: "ALexandre", last_name: "Tulip", type_of_user: "artist", artist_name: "Big Vein", music_type: "folk", artist_type: "singer-songwriter", price: "100", email: "bigvein@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/bigvein/?eid=ARB3swHmH_pgL4nDdw14g7y95VdoLHZahChgIv076mhmaqDqGBtfXw0Wtye_glZ3-KTlTO0s6rbVndWb", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
screaming_deamons = User.create!(first_name: "Dany", last_name: "Reer", type_of_user: "artist", artist_name: "Screaming Deamons", music_type: "metal", artist_type: "band", price: "250", email: "dizastra@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/screamingdemons666/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

to_the_bone = User.create!(first_name: "Janique", last_name: "Bedard", type_of_user: "artist", artist_name: "To The Bone", music_type: "funk", artist_type: "band", price: "250", email: "cormierdsad@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/tothebonegang/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

paty_withclass = User.create!(first_name: "Cristian", last_name: "Margineanu", type_of_user: "artist", artist_name: "Party With Class", music_type: "electro", artist_type: "dj", price: "350", email: "partywiiiithclass@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/partywithclass/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
el_balcon = User.create!(first_name: "Ramsey", last_name: "Allah", type_of_user: "artist", artist_name: "El Balcon", music_type: "jazz", artist_type: "band", price: "150", email: "ressnard@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/elsondelbalcon/?eid=ARDZWoukB8i8asA_N0keqyDwvAHWQfwLjaysAkvCPznuAUawaAigg_D5Mzp2cFTvur5pNc4EqzKH2Dzg", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
primitive_blue = User.create!(first_name: "Pavel", last_name: "Markovic", type_of_user: "artist", artist_name: "Primitive Blue", music_type: "folk", artist_type: "band", price: "to be discussed", email: "primitive@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/primitiveblueband/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

take_a_moment = User.create!(first_name: "Mike", last_name: "Martin", type_of_user: "artist", artist_name: "Take A Moment", music_type: "blues", artist_type: "band", price: "100", email: "tam@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/takeamomentband/?eid=ARDCU1KGz82R0LJBdO42pXbvVb511HcEwBAKVwL_XXI1FNQ8Y_Tl-Cjkmu5EMQ_ZhIa1il5T7lHXIb7y", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
orange_gecko = User.create!(first_name: "Jacquline", last_name: "Cormier", type_of_user: "artist", artist_name: "Orange Gecko", music_type: "funk", artist_type: "band", price: "150", email: "gecko@mixmyband.com", password: "123456", fb_url: "hhttps://www.facebook.com/OrangeGeck0/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

dj_mario = User.create!(first_name: "Mario", last_name: "Titelus", type_of_user: "artist", artist_name: "DJ Mario", music_type: "electro", artist_type: "dj", price: "250", email: "mario@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/Djmariotrad/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")


naomie_lafortune = User.create!(first_name: "Naomie" , last_name: "Lafortune", type_of_user: "artist", artist_name: "Noemie Lafortune", music_type: "pop", artist_type: "solo musician", price: "100", email: "naomie@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/Nomelamome/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

grenade = User.create!(first_name: "Maria", last_name: "Piquette", type_of_user: "artist", artist_name: "Grenade", music_type: "rnb", artist_type: "band", price: "100", email: "grenade@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/grenade.agence/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

pockethead = User.create!(first_name: "Richard", last_name: "Moore", type_of_user: "artist", artist_name: "Pockethead", music_type: "jazz", artist_type: "band", price: "150", email: "pocket@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/pocketheadofficial/?eid=ARAqBZOIh33wbArK4DGQDT3GuJn_HP8HUBLPaTQ4T-Is92rXNAx_V1jDZBOTel5k-YDggjIPbUN4sXvm", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

solarium = User.create!(first_name: "Alexey", last_name: "John", type_of_user: "artist", artist_name: "Solarium", music_type: "indie", artist_type: "band", price: "150", email: "fsolarium@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/solariummusique/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")

#Batch number 5 for all genres

night_snack = User.create!(first_name: "Jim", last_name: "Morrison", type_of_user: "artist", artist_name: "Night Snack", music_type: "folk", artist_type: "singer-songwriter", price: "to be discussed", email: "snack@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/nightsnackfunk/", avatar:"")
...
barber_queen = User.create!(first_name: "Dan", last_name: "Keer", type_of_user: "artist", artist_name: "Barber For The Queen", music_type: "metal", artist_type: "band", price: "150", email: "pstendddtch@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/barberforthequeen/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
...
dj_shane = User.create!(first_name: "Shane", last_name: "Oliveira", type_of_user: "artist", artist_name: "DJ Shane Oliveira", music_type: "electro", artist_type: "dj", price: "250", email: "djshane@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/DJShaneOliveira/", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")


blood = User.create!(first_name: "Viki", last_name: "Tangerine", type_of_user: "artist", artist_name: "Blood Skin Atopic", music_type: "pop", artist_type: "solo musician", price: "150", email: "vitawdng@mixmyband.com", password: "123456", fb_url: "https://www.facebook.com/Bloodskinatopic/?eid=ARA3kNz-5RecYLWLL60v5qThNZz2yBvd-2qOetll5-U5ZJ3-fDuN1TTtexolitiBxKY1i_Sk5dgh5-fM", description: "I am looking for a place to perform my new music, enjoy some beers and socialize with people interested in my genre.", avatar:"")
